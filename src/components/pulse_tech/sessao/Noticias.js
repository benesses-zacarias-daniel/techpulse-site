        ...
        <section className={style.sessao_noticias} id="noticias" ref={noticias}>
            <div className={style.conteudo_noticias}>
                ...
                <div className={style.noticias}>
                    ...
                    <Requisicao />
                    <Noticia noticiaImg={noticiaImg2} noticaAlt={"Technology"} noticiaTitulo={"Novos Smartphones Dobráveis"} noticiaDesc={"A tecnologia OLED atingiu um novo patamar de durabilidade e brilho."} />
